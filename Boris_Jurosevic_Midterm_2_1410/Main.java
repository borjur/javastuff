...
public class Main extends JPanel {
   ...
   private Point faceDwn,  faceAppear,  faceClicker;
   private Face dragginFace;
   ...
   private class FaceListener extends MouseAdapter {
      ...
      public void mousePressed(MouseEvent e) {
         if (e.getButton() == MouseEvent.BUTTON1) {
        	 faceDwn = e.getPoint();
        	 dragginFace = getFaceAt(faceDwn);
            if (dragginFace != null) {
            	dragginFace.setOffset(faceDwn);
            }
         }
      }
      ...
      public void mouseDragged(MouseEvent e) {
         ...
         faceAppear = e.getPoint();
         if (dragginFace != null) {
        	 dragginFace.setLocation(faceAppear);
         } else {
            double downX = faceDwn.getX();
            double downY = faceDwn.getY();
            double hereX = faceAppear.getX();
            double hereY = faceAppear.getY();
      ...
      public void mouseReleased(MouseEvent e) {
         ...
         if (circle != null) {
            if (faceClicker == null) {
            	faceClicker = new Point((int) circle.getCenterX(),
   ...
   private class Face extends Ellipse2D.Double {
      ...
      static final int MIN_SIDE = 35;
      final static int MOUTH_TYPES = 10;
      int mouthType;
      ...
      private void paintEye(double left, double top, double dia) {
         ...
         Point2D.Double focus = getOffCenter(eye, faceAppear);
      ...
      private void paintNose(double left, double top, double dia) {
         ...
         Point2D.Double focus = getOffCenter(nose, faceClicker);
         float[] floats = {0.01f, 0.2f, 1.0f};
         Color[] colors = {Color.WHITE, Color.GREEN, Color.GREEN.darker()};
      ...
      private Point2D.Double getIntersect(double centerX, double centerY,
         ...
         double w = Main.this.getWidth();
         double h = Main.this.getHeight();
